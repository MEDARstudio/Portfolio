...
const socialLinks = [
    ...
    { name: 'TikTok', url: '#', icon: '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 7.917v4.034a9.948 9.948 0 0 1 -5 -1.951v4.5a6.5 6.5 0 1 1 -8 -6.326v4.326a2.5 2.5 0 1 0 4 2v-11.5h4.083a6.005 6.005 0 0 0 4.917 4.917z" /></svg>' },
    { name: 'Behance', url: '#', icon: '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 18v-12h4.5a3 3 0 0 1 0 6a3 3 0 0 1 0 6h-4.5" /><path d="M3 12h4" /><path d="M14 13h7" /><path d="M14 18h7" /><path d="M21 15.5a2.5 2.5 0 0 0 -5 0" /></svg>' },
    { name: 'WhatsApp', url: '#', icon: '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 21l1.65 -3.8a9 9 0 1 1 3.4 2.9l-5.05 .9" /><path d="M9 10a.5 .5 0 0 0 1 0v-1a.5 .5 0 0 0 -1 0v1a5 5 0 0 0 5 5h1a.5 .5 0 0 0 0 -1h-1a.5 .5 0 0 0 0 1" /></svg>' },
...
function setup3DTiltEffects() {
    ...
    portfolioItems.forEach(item => {
        ...
        const inner = item.querySelector<HTMLElement>('.portfolio-item-inner');
        if (!inner) return;

        // FIX: Explicitly type event as MouseEvent to access clientX/clientY.
...
function setupImageLightbox() {
    ...
    portfolioGrid.addEventListener('click', (e) => {
        const portfolioItem = (e.target as HTMLElement).closest('.portfolio-item');
        if (portfolioItem) {
